    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <img src="{{asset('website/themes/assets/images/1.png')}}" alt="Generic placeholder image" style="width: 100%">
            ...
            <div class="item">
                <img src="{{asset('website/themes/assets/images/2.png')}}" alt="Generic placeholder image" style="width: 100%">
                <div class="carousel-caption">
                    <a class="btn btn-lg btn-default" href="{{url('room')}}" role="button" style="font-size:2em">Book Room Online Now &raquo;</a>
                </div>
            </div>
            ...
            <div class="item">
                <img src="{{asset('website/themes/assets/images/3.png')}}" alt="Generic placeholder image" style="width: 100%">
                <div class="carousel-caption">
                    <a class="btn btn-lg btn-default" href="{{url('room')}}" role="button" style="font-size:2em">Book Room Online Now &raquo;</a>
                </div>
            </div>
...
<div class="mainTitle">
    ...
    <div class="col-md-2 pull-right">
        <img class="img-rounded img-responsive"><img src="{{asset('website/themes/assets/images/logo.jpg')}}" style="width: 200px;height: 150px"></img>
    </div>
    </div>
</div>
