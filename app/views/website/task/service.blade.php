...
<div class="container marketing"> <!-- Three columns of text below the carousel -->
    <div class="row">
        <div class="col-lg-4">
<!--            <i class="fa fa-home fa-5x text-success"></i><br>-->
            <img class="img-circle" src="{{asset('website/themes/assets/images/lodge.jpg')}}" alt="Generic placeholder image"><br>
            ...
            <p><a class="btn btn-default" href="{{url('lodge')}}" role="button">More &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" style="height: 170px" src="{{asset('website/themes/assets/images/Restaurant-Blue-2-icon.png')}}" alt="Generic placeholder image"><br>
            ...
            <p><a class="btn btn-default" href="{{url('restaurant')}}" role="button">More &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" style="width: 200px; height: 170px" src="{{asset('website/themes/assets/images/activitiesIcon.jpg')}}" alt="Generic placeholder image"><br>
