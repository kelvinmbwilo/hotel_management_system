...
<div class="pageTitle">
    <div class="container">
        ...
        <ul class="nav navbar-nav">
            <li><a href="{{url('#')}}">Serengeti National Park</a></li>
...
<div class="container">
    <div class="bodyInner">
        <div class="row">
            ...
            <div class="col-md-3">
                <img  class="img"  style="width: 400px; height: 300px;box-shadow: 5px 5px 10px #888888"  src="{{asset('website/themes/assets/images/download (3).jpg')}}" alt="Generic placeholder image">
            </div>
            <div class="col-md-1">
        ...
        From Tembo Tarangire lodge & camp is 265km to Serengeti National Park (about 5.5hrs)</p>
    </div>
</div>
